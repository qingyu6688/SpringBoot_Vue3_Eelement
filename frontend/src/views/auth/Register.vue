    ...
    <div class="auth-container">
      ...
      <div class="brand-section">
        ...
        <div class="brand-content">
          <h2 class="brand-title">构建下一代<br>企业级数字化底座</h2>
          <p class="brand-desc">
            基于 SpringBoot 3 与 Vue 3 的现代化解决方案。安全、高效、开箱即用。
          </p>
        </div>
      ...
      <div class="form-section">
        ...
        <div class="form-header">
          ...
          <p class="form-subtitle">填写以下信息注册您的管理员账号</p>
        </div>
...
import { User, Lock, Message, Grid } from '@element-plus/icons-vue'
